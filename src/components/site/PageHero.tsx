  ...
  return (
    <section className="relative min-h-[60vh] w-full overflow-hidden">
      <img
        ...
        loading="eager"
      />
      <div className="absolute inset-0 bg-gradient-to-br from-[#032E59]/90 via-[#032E59]/75 to-[#01969C]/70" />
      <div className="relative mx-auto flex min-h-[60vh] max-w-7xl flex-col justify-center px-6 pb-16 pt-36 md:px-8 md:pt-40">
        {eyebrow && (
