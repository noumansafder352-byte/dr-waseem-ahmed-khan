...
export function PageHero({
  ...
  const heightClass = tall ? "min-h-[70vh]" : "min-h-[60vh]";
  return (
    <section className={`relative ${heightClass} w-full overflow-hidden`}>
      ...
      <div className={`relative mx-auto flex ${heightClass} max-w-7xl flex-col justify-center px-6 pb-16 pt-36 md:px-8 md:pt-40`}>
        {eyebrow && (
